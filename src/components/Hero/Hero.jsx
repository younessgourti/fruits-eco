        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
            ...
            <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                <div className=' text-center md:text-left space-y-6 lg:max-w-[400px]'>
                    ...
                    initial="hidden"
                    animate="visible"
                     className='text-gray-400'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta corrupti possimus, temporibus sunt quidem ratione sit culpa beatae enim totam quaerat commodi. Quam eveniet ea modi dignissimos, illum porro ducimus.</motion.p>
